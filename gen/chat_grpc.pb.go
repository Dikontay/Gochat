...
const (
	Broadcast_CreateStream_FullMethodName     = "/hello.Broadcast/CreateStream"
	Broadcast_BroadcastMessage_FullMethodName = "/hello.Broadcast/BroadcastMessage"
)
